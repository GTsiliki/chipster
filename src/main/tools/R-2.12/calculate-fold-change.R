...
# PARAMETER order [normal, reversed] DEFAULT normal (Defines which samples to treat as reference group. In the "normal" mode the group belonging
# of the fist sample is assumed to be the reference, whereas in the "resversed" mode the situation is reversed. Note that this is different to how
